...
import portalLogo from "./assets/tn logo from team.jpeg";
...
function Navbar() {
  ...
  const navLinks = [
    ...
    { label: isTamil ? "புகார் பதிவு" : "Raise Complaint", to: "#" },
    { label: isTamil ? "புகார் கண்காணிப்பு" : "Track Complaint", to: "#" },
    { label: isTamil ? "துறைகள்" : "Departments", to: "#departments" },
    { label: isTamil ? "உதவி" : "Help", to: "#help" },
    { label: isTamil ? "நிர்வாக உள்நுழைவு" : "Admin Login", to: "#" },
  ];

  return (
    <header className="sticky top-0 z-50 bg-[#0F766E] text-white shadow-lg">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center gap-4">
            <div className="overflow-hidden rounded-full border-2 border-[#F4B400] bg-white p-1 shadow-md">
              <img
                src={portalLogo}
            ...
            <div>
              ...
              <p className="text-xs text-slate-200">{isTamil ? "தமிழ்நாடு அரசு" : "Government of Tamil Nadu"}</p>
            </div>
          </div>
